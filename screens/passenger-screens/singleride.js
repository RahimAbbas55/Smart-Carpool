  ...
  const handleFindDriver = async () => {
    try {
      ...
      const rideData = {
        ...
        passengerCurrentLocationLatitude: data.passengerCurrentLocationLatitude,
        passengerCurrentLocationLongitude:data.passengerCurrentLocationLongitude,
        ...
        <View style={styles.optionsContainer}>
          ...
          >
            <MaterialIcons
              name="woman"
              size={40}
              color={selectedDriver === "female" ? "#007bff" : "#000"}
            />
            <Text>Female</Text>
          </TouchableOpacity>
          <TouchableOpacity
          ...
          >
            <MaterialIcons
              name="man"
              size={40}
              color={selectedDriver === "male" ? "#007bff" : "#000"}
            />
            <Text>Male</Text>
          </TouchableOpacity>
        </View>
