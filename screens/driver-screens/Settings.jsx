...
export default function Profile({ navigation }) {
  const { driverDetails, setDriverDetails } = useDriverData();
  ...
  const uploadImageToImgBB = async (imageUri) => {
    setUploading(true);
    const apiKey = "Y068837d15525cd65b1c49b07e618821b";
  ...
  const handleSubmit = async () => {
    try {
        const formattedUpdates = {
            ...
            driverDOB: formData.dateOfBirth,
            ...
            driverSelfie: formData.driverPhoto
        };
        
        
        const serverURL = getBackendUrl();
      const response = await axios.put(`${serverURL}driver/updateDriver`, {
        id,
      ...
      if (response.status === 200) {
        ...
        console.log('Settings.js: Error updating driver' , error)
    }
  };
